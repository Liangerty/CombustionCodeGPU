...
//                  Species &spec, const Parameter &parameter);
...
//  const std::string default_init = parameter.get_string(inflow_name);
...
//    const std::map<std::string, std::variant<std::string, integer, real>> &info, Species &spec,
//    const Parameter &parameter):label{
